...
export default function LeftSidebar() {
  ...
  if (isMobile) {
    return (
      <motion.nav
        className="fixed bottom-3 left-3 right-3 z-50 rounded-2xl overflow-hidden shadow-xl"
        initial={{ y: 100 }}
        animate={{ y: 0 }}
  ...
  return (
    <motion.aside
      className="fixed top-0 left-0 h-screen w-64 px-6 py-8 bg-white/80 backdrop-blur-md border-r border-gray-200 shadow-xl z-50 flex flex-col"
