...
const EmptyFeed = ({ isAuthenticated, handleCreatePost, error, onLogin }) => {
  ...
  return (
    <div className="py-16 flex flex-col items-center px-6">
      ...
      />
      <h2 style={{ fontFamily: fonts.Bold }} className="text-xl text-gray-700 mb-2 text-center">
        {hasAuthError ? 'Session Expired' : 'No posts yet'}
      </h2>
      <p style={{ fontFamily: fonts.Regular }} className="text-base text-gray-500 mb-6 text-center">
        {hasAuthError 
