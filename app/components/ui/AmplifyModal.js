...
const AmplifyModal = ({ visible, onClose, post, token, onSuccess }) => {
  ...
  const handleAmplify = async () => {
    ...
    try {
      ...
      const response = await fetch(
        `${API_ENDPOINTS.SOCIAL}/posts/${post.id}/amplify`,
        {
          method: "POST",
          headers: {
  ...
  const handleQuote = async () => {
    ...
    try {
      setLoading(true);
      const response = await fetch(
        `${API_ENDPOINTS.SOCIAL}/posts/${post.id}/quote`,
        {
          method: "POST",
          headers: {
            Authorization: `Bearer ${token}`,
        ...
        {mode === "options" ? (
          <>
            <div className="p-4 ">
              ...
              {post && (
                <div className="flex items-center m-4 p-3 bg-gray-50 dark:bg-gray-800 rounded-xl overflow-hidden">
                  <img
                  ...
                  <div className="ml-3 flex-1 min-w-0">
                    <p className="font-medium text-gray-800 dark:text-white">{post.username}</p>
                    <p className="text-sm text-gray-600 dark:text-gray-300 mt-1 line-clamp-2 break-words overflow-hidden">
                      {post.content}
                    </p>
                  </div>
                </div>
            ...
            <button
              className="flex items-center w-full px-6 py-4 border-t border-gray-100 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-800 disabled:opacity-50 rounded-2xl"
            ...
            >
              ...
              <div className="flex-1 cursor-pointer text-left">
                <p className="font-medium  text-gray-800 dark:text-white">Amplify</p>
            ...
            <button
              className="flex items-center w-full px-6 py-4 border-t border-gray-100 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-800 rounded-2xl"
            ...
            >
              ...
              <div className="flex-1 cursor-pointer text-left">
                <p className="font-medium text-gray-800 dark:text-white">Amplify with Quote</p>
                <p className="text-sm text-gray-600 dark:text-gray-300">
          ...
          <div className="p-4">
            <div className="flex justify-between items-center mb-4">
              ...
              >
                <ArrowLeft size={20} className="text-gray-600 dark:text-gray-300 cursor-pointer" />
              </button>
            </div>

            <textarea
              className="w-full bg-gray-50 dark:bg-gray-800 rounded-xl p-4 min-h-32 text-base text-gray-800 dark:text-white mb-4 resize-none focus:outline-none focus:ring-2 focus:ring-primary"
            ...
            {post && (
              <div className="border border-gray-200 dark:border-white rounded-xl p-3 mb-3 overflow-hidden">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-300 mb-2 break-words whitespace-pre-wrap">
                  {post.content}
                </p>
